...
import com.example.mongo.domain.repository.authentication.PasswordReissueInfoRepository;
...
import static com.example.mongo.app.common.constants.MessageKeys.*;
...
public class PasswordReissueServiceImpl implements PasswordReissueService {
    ...
    public String createAndSendReissueInfo(String username) {
        ...
        PasswordReissueInfo info = passwordReissueInfoRepository.insert(
